...
void setup()
{
    ...
    lv_label_set_text(label_1, "OceanDesk");
    ...
    lv_label_set_text_fmt(label_3, "Display: OK\nTouch: OK\nWi-Fi: Not configured", LVGL_VERSION_MAJOR, LVGL_VERSION_MINOR, LVGL_VERSION_PATCH);
    ...
    lv_label_set_text(button_label, "TOCAR AQUI");
