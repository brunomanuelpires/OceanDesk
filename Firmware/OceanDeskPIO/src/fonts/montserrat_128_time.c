 ...
 * Size: 128 px
 * Bpp: 4
 * Opts: --font tools/fonts/Montserrat-Regular.ttf --symbols 0123456789:- --size 128 --bpp 4 --format lvgl --no-compress --no-prefilter --force-fast-kern-format --lv-include lvgl.h --lv-font-name montserrat_128_time --output src/fonts/montserrat_128_time.c
 ******************************************************************************/
...
#ifndef MONTSERRAT_128_TIME
#define MONTSERRAT_128_TIME 1
#endif

#if MONTSERRAT_128_TIME
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 782, .box_w = 35, .box_h = 8, .ofs_x = 7, .ofs_y = 31},
    {.bitmap_index = 140, .adv_w = 1356, .box_w = 73, .box_h = 92, .ofs_x = 6, .ofs_y = -1},
    {.bitmap_index = 3498, .adv_w = 739, .box_w = 31, .box_h = 90, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4893, .adv_w = 1163, .box_w = 66, .box_h = 91, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 7896, .adv_w = 1155, .box_w = 65, .box_h = 91, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 10854, .adv_w = 1354, .box_w = 78, .box_h = 90, .ofs_x = 5, .ofs_y = 0},
    {.bitmap_index = 14364, .adv_w = 1159, .box_w = 66, .box_h = 91, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 17367, .adv_w = 1247, .box_w = 68, .box_h = 92, .ofs_x = 6, .ofs_y = -1},
    {.bitmap_index = 20495, .adv_w = 1206, .box_w = 66, .box_h = 90, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 23465, .adv_w = 1307, .box_w = 70, .box_h = 92, .ofs_x = 6, .ofs_y = -1},
    {.bitmap_index = 26685, .adv_w = 1247, .box_w = 69, .box_h = 92, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 29859, .adv_w = 434, .box_w = 15, .box_h = 69, .ofs_x = 6, .ofs_y = -1}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t montserrat_128_time = {
#else
lv_font_t montserrat_128_time = {
#endif
